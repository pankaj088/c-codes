#include <stdio.h>
void printadd(int a){  // function banya
...
int main() // main function hai
{
    ...
    printadd( i); // yaha pai value ko pass karya hai islye eska value same nhi hoga , (address pass nhi karbaya hai) /// function ko call kiya
